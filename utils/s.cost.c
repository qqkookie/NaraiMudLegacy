h14079
s 00001/00001/00452
d D 1.3 94/11/18 22:27:08 yunbum 3 2
c Make minimum cost 10 coins
e
s 00145/00067/00308
d D 1.2 94/10/25 12:09:40 yunbum 2 1
c consider - values
e
s 00375/00000/00000
d D 1.1 94/09/23 22:07:13 yunbum 1 0
c date and time created 94/09/23 22:07:13 by yunbum
e
u
U
t
...
char fileid[] = "%W% %E% by Cold" ;

I 2
D 3
#define	LEAST_ITEM_COST	50
E 3
I 3
...
D 2
		armor = intabs(obj->obj_flags.value[0]) ;
E 2
I 2
...
D 2
	...
	switch ( type ) {
		case APPLY_DAMROLL :	cost = 300 + 120 * (x + 1)*(x + 1) ;
			break ;
		case APPLY_HITROLL :
