...
char LOWER(char ch) ;	/* funtion in utility.c */
...
/* CAN_SEE function in utility.c : does 'sub' can see 'obj' ?  */
int CAN_SEE(struct char_data *sub, struct char_data *obj) ;
...
#define GET_CLASS(ch)   ((ch)->player.class & 0x0f)
#define GET_CLASS_O(ch) (((ch)->player.class & 0xf0) >> 4)
...
#define GET_MOB_WAIT(ch) ((ch)->specials.wait_state)
...
#define GET_OBJ_STAT(obj) ((obj)->obj_flags.extra_flags)
#define GET_OBJ_RENTCOST(obj)	((obj)->obj_flags.rentcost)



/* PERS function in utility.c : return name of object  */
