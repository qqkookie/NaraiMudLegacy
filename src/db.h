...
#define ANNOUNCE_FILE 	  "announce"	  /* for announce : jmjeong     */
#define FORTUNE_COOKIE_FILE "cookie"      /* for fortune cookie  : cyb  */
#define MAX_FORTUNE_COOKIE 1000  /* size of cookie file (number of line) */
